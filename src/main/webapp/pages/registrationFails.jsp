...
<div class="container" style="width: 1000px ;" align="center">
    ...
    <p class="lead" style="color: steelblue;">
        К сожалению такой логин существует либо введены не корректрые данные
    </p>
...
<div class="container" style="width: 300px;">
    ...
    <form action="${reg}" method="post">
        ...
        <input type="text" class="form-control" name="j_username" placeholder="Ваш логин">
        <input type="password" class="form-control" name="j_password" placeholder="Ваш пароль">
        <input type="text" class="form-control" name="j_email" placeholder="Ваш email">
...
<div class="container" style="width: 370px;">
    ...
    <p class="lead" style="color: steelblue;" align="center">
        Все поля должны быть заполнены и не содержать пробелы
    </p>
